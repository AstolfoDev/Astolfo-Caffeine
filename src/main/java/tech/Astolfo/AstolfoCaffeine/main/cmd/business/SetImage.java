...
public class SetImage extends Command {
    ...
    private boolean pistachio(CommandEvent e) {
        ...
        if (!(admins.contains(e.getAuthor().getIdLong()))) {
            e.reply(new Logging().error("oi! ur not an admin or owner of the business, u canzzz change da logo!!"));
            return false;
        }
    ...
    private void hazelnut(CommandEvent e) {
    ...
    private void description(CommandEvent e) {
