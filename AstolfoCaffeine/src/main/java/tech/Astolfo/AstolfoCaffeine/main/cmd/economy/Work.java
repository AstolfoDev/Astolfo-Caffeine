...
public class Work extends Command {
  ...
  private EventWaiter waiter;
    ...
    protected void execute(CommandEvent e) throws NumberFormatException {
        ...
        toolbox.addTool(new Tool(2, 0, 0, msg.getGuild().getEmotes().get(0)));
        toolbox.addTool(new Tool(0, 0, 1, msg.getGuild().getEmotes().get(1)));
        Block block = new Block("Imo-Imo", "https://cloud.orz.cx/public/ImoImo/%d.jpg", Block.Material.STONE, 2, 3, 10, 10);
        msg.getChannel().sendMessage("temp").queue(
